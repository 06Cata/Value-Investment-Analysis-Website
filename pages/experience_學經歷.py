...
def main():
    ...
    st.write("為了深入學習，自九月底以來，觀看了Udemy及一些開放式平臺課程，來加強技能、練習Kaggle案例，希望能彌補自身背景的不足，\
    ...
    st.write("數位行銷 : 與媒體公司的合作中，開啟新的西班牙語網站專案，每日訪客人數從10~20人/日到，平均超過300人/日，增長率超過 1400%；\
                ...
                關鍵詞上台灣Google搜索引擎首頁排名，這些經歷也成為我轉職的契機") 
    st.subheader("")
    st.subheader("")
    ...
    st.write("在倉管部，統計和協調每日生產計劃；在會計行政部門，賬目對賬、文件處理、生產產品顏色檢查、\
                與當地業務團隊合作協助催帳、核銷賬目")
    st.subheader("")
    st.subheader("")
